...
public class MainDrawerActivity extends AppCompatActivity
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setTitle( getResources().getString(R.string.principal));
    ...
    public boolean onNavigationItemSelected(MenuItem item) {
        ...
        switch (id) {
            ...
            case R.id.mbares:
                intent = new Intent(MainDrawerActivity.this, BarDrawerActivity.class);
            ...
            case R.id.mrestaurante:
                intent = new Intent(MainDrawerActivity.this, RestauranteDrawerActivity.class);
                intent.putExtra("usuario", usuario);
                intent.putExtra("correo", correo);
                startActivity(intent);
                ...
                break;
            case R.id.mhoteles:
                intent = new Intent(MainDrawerActivity.this, HotelDrawerActivity.class);
                intent.putExtra("usuario", usuario);
                intent.putExtra("correo", correo);
            ...
            case R.id.mPrincipal:
                intent = new Intent(MainDrawerActivity.this, MainDrawerActivity.class);
                intent.putExtra("usuario", usuario);
                intent.putExtra("correo", correo);
                ...
                break;
            case R.id.mextras:
                intent = new Intent(MainDrawerActivity.this, ExtraDrawerActivity.class);
                intent.putExtra("usuario", usuario);
                intent.putExtra("correo", correo);
