...
public class BarDrawerActivity extends AppCompatActivity
    ...
    public void onBackPressed() {
        ...
        if (drawer.isDrawerOpen(GravityCompat.START)) {
            ...
            super.onBackPressed();
        }//con este metodo cierra el menu desplegado a la izquierda pero sin cerrar la acitividad
    }
    ...
    public boolean onNavigationItemSelected(MenuItem item) {
        ...
        switch (id) {
            case R.id.mbares:
                intent = new Intent(BarDrawerActivity.this, BarDrawerActivity.class);
            ...
            case R.id.mrestaurante:
                intent = new Intent(BarDrawerActivity.this, RestauranteDrawerActivity.class);
                intent.putExtra("usuario", usuario);
                intent.putExtra("correo", correo);
                startActivity(intent);
                break;
            case R.id.mhoteles:
                intent = new Intent(BarDrawerActivity.this, HotelDrawerActivity.class);
                intent.putExtra("usuario", usuario);
                intent.putExtra("correo", correo);
            ...
            case R.id.mPrincipal:
                intent = new Intent(BarDrawerActivity.this, MainDrawerActivity.class);
                intent.putExtra("usuario", usuario);
                intent.putExtra("correo", correo);
                ...
                break;
            case R.id.mextras:
                intent = new Intent(BarDrawerActivity.this, ExtraDrawerActivity.class);
                intent.putExtra("usuario", usuario);
                intent.putExtra("correo", correo);
            ...
            case R.id.mPerfil:
                intent = new Intent(BarDrawerActivity.this, PerfilDrawerActivity.class);
                intent.putExtra("usuario", usuario);
                intent.putExtra("correo", correo);
                ...
                break;
            case R.id.mLogOut:
                intent = new Intent(BarDrawerActivity.this, LoginActivity.class);
                intent.putExtra("usuario", usuario);
                intent.putExtra("correo", correo);
        ...
        public Fragment getItem(int position) {
            ...
            switch (position){
                ...
                case 2: BarTresFragment tab3 = new BarTresFragment();
                    return  tab3;
                case 3: BarMapFragment tab4 = new BarMapFragment();
                    return  tab4;
